              ...
              <div class="card">
                <div class="card-body">
                  @if ($errors->any())
                                ...
                                @endif
                  <h4 class="card-title">Let's Verify you</h4>
              

                  <div class="card-description mt-4"><p>Verification code has been sent to {{$email}}</p></div>

                  <form class="forms-sample" action="/verify-email-code-now" method="GET">
                    @csrf

                    <div class="form-group">
                        <input type="text" readonly value="{{$email}}" name="email" class="form-control" name="code" id="code" placeholder="Enter code" autofocus >
                      </div>

                    <div class="form-group">
                      <label for="email">Enter Code</label>
                      <input type="number" required class="form-control" name="code" id="code" placeholder="Enter code" autofocus >
                    </div>
                    ...
                    <a href="/resend-code?email={{$email}}" >Resend Code</a>
