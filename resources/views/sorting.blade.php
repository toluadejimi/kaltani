...
<div class="main-content">
    ...
    <div class="row">
        <div class="col-md-12 shadow-sm table-responsive">
            ...
            <table id="myTable" class="table table-striped mb-0 table-responsive">
                <thead>
                    <tr>
                ...
                <tbody id="geeks">
                    ...
                    <tr>
                        ...
                        <td>{{$item->brown}}kg</td>
                        <td>{{$item->black}}kg</td>
                        <td>{{$item->black + $item->brown +  $item->ldpe +  $item->hdpe + $item->Caps + $item->Trash +  $item->Others + $item->Green_Colour +  $item->Clean_Clear  }}kg</td>
                        <td>
